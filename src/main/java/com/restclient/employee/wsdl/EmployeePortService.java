 ...
 * 
 */
@WebServiceClient(name = "EmployeePortService", targetNamespace = "employee.soap", wsdlLocation = "http://localhost:8080/service/employeesWsdl.wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEEPORTSERVICE_QNAME = new QName("employee.soap", "EmployeePortService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/service/employeesWsdl.wsdl");
    ...
    public EmployeePort getEmployeePortSoap11() {
        return super.getPort(new QName("employee.soap", "EmployeePortSoap11"), EmployeePort.class);
    }
    ...
    public EmployeePort getEmployeePortSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("employee.soap", "EmployeePortSoap11"), EmployeePort.class, features);
    }
