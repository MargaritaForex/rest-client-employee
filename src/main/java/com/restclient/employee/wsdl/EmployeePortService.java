 ...
 *
 */
@WebServiceClient(name = "EmployeePortService", targetNamespace = "employee.soap", wsdlLocation = "http://localhost:8089/service/employeesWsdl.wsdl")
        ...
        extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8089/service/employeesWsdl.wsdl");
